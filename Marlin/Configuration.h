...
#define STRING_CONFIG_H_AUTHOR "(R0ms, Ender-3)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 93 } // was { 80, 80, 400, 100 } on old config
...
#define Z_PROBE_FEEDRATE_SLOW (Z_PROBE_FEEDRATE_FAST / 3) //#define Z_PROBE_FEEDRATE_SLOW (Z_PROBE_FEEDRATE_FAST / 2)
